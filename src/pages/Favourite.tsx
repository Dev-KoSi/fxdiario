            ...
            <section className='posts'>
                <div className="post">
                    <div className="details">
                        ...
                        <div className="fav">
                            <svg id='fav' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#000000" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
